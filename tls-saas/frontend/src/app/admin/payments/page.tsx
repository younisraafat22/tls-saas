              ...
              <div className="space-y-3 text-sm">
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <div className="font-medium">{detailPayment.submitter_name || detailPayment.user_name || "—"}</div>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <div className="text-gray-400 text-xs mb-1">Email</div>
                    <div className="font-medium break-all">{detailPayment.submitter_email || detailPayment.user_email || "—"}</div>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <div className="text-gray-400 text-xs mb-1">Plan</div>
                    <div className="font-medium">{detailPayment.plan_key || "—"}</div>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
